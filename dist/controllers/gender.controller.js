...
var genderServices = require("../services/gender.service");
var getGenderList = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var genderList;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, genderServices.getAllGenderList()];
            case 1:
                genderList = _a.sent();
                console.log("controller in get ".concat(JSON.stringify(genderList)));
                try {
